      ...
      <div className="row">
        ...
        <ul className="contact-info-more">
          <li className="contact-item">
            <span>
              <img src="/icon/mdi" alt="" />
            </span>
            petpal@gmail.com
          </li>
          <li className="contact-item">0977354956</li>
          <li className="contact-item">Số 96, Định Công, Hà Nội</li>
          <li className="contact-item">www.petpals.com</li>
        </ul>
      </div>
    </footer>
  );
