    ...
    <main>
      ...
      <section className="service-section">
        ...
        <div className="service-content">
          ...
          Lấy cao răng: Bằng cách sử dụng thiết bị lấy cao răng chuyên dụng, đội
          ngũ bác sĩ giàu kinh nghiệm của chúng tôi sẽ làm sạch từng chiếc răng
          một cách tỉ mỉ và không gây đau đớn hay chảy máu chân răng.
        </div>
      </section>
    </main>
  );
