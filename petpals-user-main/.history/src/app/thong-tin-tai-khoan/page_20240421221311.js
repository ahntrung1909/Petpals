                  ...
                  <>
                    <div className="table">
                      ...
                      {currentUser.pets.map((pet, index) => {
                        <div className="table-row  pet-table">
                          <div className="table-col">{index}</div>
                          <div className="table-col">
                            <img src="/img/petAva/pet_img_1.jpg" alt="" />
                          </div>
                          <div className="table-col">{pet.name}</div>
                          <div className="table-col">Chó</div>
                          <div className="table-col">Đực</div>
                          <div className="table-col">Chó Shiba</div>
                          <div
                            className="table-col"
