        ...
        <div className="service-content">
          ...
          <div>
            <ul>
              ...
              <li>
                Phẫu thuật mổ sạn bàng quang, mổ sỏi thận: Chó mèo khi bị sỏi
                trong cơ thể cần được xử lý kịp thời để tránh nguy hiểm. Nguyên
                nhân có thể là do uống ít nước, ăn thức ăn giàu đạm hoặc mặn,
                nhiễm trùng đường tiết niệu. Phẫu thuật sẽ được thực hiện để
                loại bỏ sỏi từ thận hoặc bàng quang sau khi chẩn đoán bằng siêu
                âm.
              </li>
              <li>
                <b>Phẫu thuật triệt sản:</b> Là quá trình cắt bỏ bộ phận sinh
