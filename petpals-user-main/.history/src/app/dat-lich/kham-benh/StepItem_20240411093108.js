    ...
    return (
      <form>
        ...
        <div>
          <p>Buổi sáng</p>
          <div className="form-row">
            <label htmlFor="custom-time time-1">9:00 -10:00</label>
            <input type="radio" name="time" id="time-1" value="9:00 - 10:00" />
            <label htmlFor="custom-time time-2">10:00 -11:00</label>
            <input type="radio" name="time" id="time-1" value="10:00 - 11:00" />
            <label htmlFor="custom-time time-3">11:00 -12:00</label>
            <input type="radio" name="time" id="time-1" value="11:00 - 12:00" />
          </div>
        </div>
      </form>
    );
