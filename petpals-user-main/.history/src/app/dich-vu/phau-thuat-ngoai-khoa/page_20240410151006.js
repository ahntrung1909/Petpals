        ...
        <div className="service-content">
          ...
          <div>
            <ul>
              ...
              <li>
                Phẫu thuật mổ Hernie: Đây là hiện tượng chó mèo bị sa ruột
                (thoát vị rốn) do bị di tật bẩm sinh, do cắt rốn không đúng kỹ
                thuật, khi đó rốn có một lỗ nhỏ không được đóng kín, các nội
                tạng trong bụng theo lỗ này thoát ra ngoài. Ban đầu tại rốn chỉ
                là một cục thịt nhỏ cỡ ngón tay nhô lên, càng lâu nó càng to lên
                và gây nguy hiểm cho vật nuôi. Phẫu thuật mổ Hernie là cắt bỏ
                cục u khi còn nhỏ. Tuy vậy hiện tượng này rất dễ bị tái lại.
              </li>
              <li>
                <b>Phẫu thuật triệt sản:</b> Là quá trình cắt bỏ bộ phận sinh
                dục để ngăn chặn khả năng sinh sản. Bằng cách loại bỏ tử cung và
