      ...
      <section className="service-section">
        ...
        <div className="service-content">
          ...
          <div>
            <ul>
              <li>
                Đội ngũ chuyên gia tận tâm: Đội ngũ bác sĩ giàu kinh nghiệm và
                yêu thương động vật sẽ chăm sóc răng miệng của thú cưng bạn với
                sự tận tâm và chuyên nghiệp.
              </li>
              <li>
                Quy trình an toàn và hiện đại: Chúng tôi tuân thủ quy trình lấy
                cao răng nghiêm ngặt, sử dụng thiết bị và công nghệ tiên tiến để
