      ...
      <section className="service-section">
        ...
        <div className="service-content">
          ...
          <p>
            ...
            Chúng tôi luôn tận dụng tối đa mọi nguồn lực để tiết kiệm chi phí
            cho khách hàng, bạn có thể yên tâm rằng sẽ luôn nhận được chất lượng
            dịch vụ tốt nhất với chi phí phù hợp. Đội ngũ Petpals sẽ đồng hành
            cùng bạn và thú cưng của mình trong mọi tình huống khẩn cấp, cấp
            cứu. Chúng tôi luôn sẵn sàng để hỗ trợ và đảm bảo rằng thú cưng của
            bạn nhận được sự chăm sóc y tế tốt nhất, bất kể khung thời gian hay
