        ...
        <div className="service-content">
          ...
          <div>
            <ul>
              ...
              <li>
                Tiểu phẫu khâu da: Trong trường hợp chó mèo gặp vết thương
                nghiêm trọng không tự lành, hãy đưa ngay thú cưng của bạn đến
                bác sĩ thú y. Vết thương đâm sâu qua da và ảnh hưởng đến cơ, gân
                và lớp mỡ bên trong cần được xử lý chuyên nghiệp. Sau khi kiểm
                tra, bác sĩ thú y có thể tiến hành khâu vết thương để giúp chó
                mèo bạn hồi phục nhanh chóng.
              </li>
              <li>
                <b>Phẫu thuật triệt sản:</b> Là quá trình cắt bỏ bộ phận sinh
                dục để ngăn chặn khả năng sinh sản. Bằng cách loại bỏ tử cung và
