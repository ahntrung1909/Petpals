        ...
        <div className="service-content">
          ...
          <div>
            <ul>
              ...
              <li>
                ️Gây mê: Sau khi xác định sức khỏe của thú cưng, chúng tôi sẽ
                tiến hành quá trình gây mê an toàn để thú cưng của bạn không cảm
                thấy đau đớn và không thoải mái.
              </li>
              <li>
                Lấy cao răng: Bằng cách sử dụng thiết bị lấy cao răng chuyên
                dụng, đội ngũ bác sĩ giàu kinh nghiệm của chúng tôi sẽ làm sạch
                từng chiếc răng một cách tỉ mỉ và không gây đau đớn hay chảy máu
                chân răng.
              </li>
            </ul>
          </div>
